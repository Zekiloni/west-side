...
<div class="modal-dialog modal-dialog-centered">
    ...
    <a href="#" id="close-search" onclick="closeSearch()"><i class="fa fa-times" aria-hidden="true"></i></a>
       <img class="img img-responsive" src="assets/images/logo.png" width="100">
       <form class="form-signin py-5" method="POST" >
						  <div class="form-label-group">
						  <label for="email">Korisnička Adresa: </label>
						  ...
						  <div class="form-label-group py-3">
							  ...
							  <input type="password" name="password" id="password" placeholder="šifra korisnička">
						  </div>
						  <div class="custom-control custom-checkbox mb-3">
							<input type="checkbox" class="custom-control-input" id="customCheck1">
							<label class="custom-control-label" for="customCheck1">Zapamti me</label>
						  </div>
